  ...
  const selectMenu = new StringSelectMenuBuilder()
    ...
    .addOptions(
      new StringSelectMenuOptionBuilder()
        ...
        .setDescription('5 bậc Linh Căn: hệ số EXP, HP, sát thương & giảm lôi kiếp')
        .setValue('help_talent')
        .setEmoji('🧬'),
      new StringSelectMenuOptionBuilder()
        .setLabel('2. Trận Doanh Chính - Ma - Tán Tu')

        .setDescription('Buff nội tại thật của Chính Đạo / Ma Đạo / Tán Tu')
      ...
      new StringSelectMenuOptionBuilder()
        ...
        .setDescription('Luyện 6 phương thuốc, Chợ Trời & thuế giao dịch 5%')
      ...
      new StringSelectMenuOptionBuilder()
        ...
        .setDescription('Khay chiến đấu !kichhoat, thuần thục & dung hợp 5 bí kíp')
        .setValue('help_skills')
        .setEmoji('📜'),
      new StringSelectMenuOptionBuilder()

        .setLabel('7. Săn Thú, Khai Khoáng, Đổ Thạch & PvP')
        .setDescription('Mọi lệnh kiếm tài nguyên, hồi chiêu thật & luật đấu PvP')
